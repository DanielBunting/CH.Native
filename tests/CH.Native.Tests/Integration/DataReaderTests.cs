...
public class DataReaderTests
{
    ...
    public async Task QueryAsync_EmptyResult_YieldsNothing()
    {
        ...
        var count = 0;
        await foreach (var row in connection.StreamAsync("SELECT 1 WHERE 1 = 0"))
        {
            count++;
        }
    ...
    public async Task QueryAsync_AccessByIndex_Works()
    {
        ...
        await foreach (var row in connection.StreamAsync("SELECT 42 as value, 'test' as text"))
        {
            // Access by index
    ...
    public async Task QueryAsyncT_MapsToDto()
    {
        ...
        await foreach (var item in connection.StreamAsync<SimpleDto>(
    ...
    public async Task QueryAsyncT_MissingColumn_LeavesDefault()
    {
        ...
        await foreach (var item in connection.StreamAsync<PartialDto>(
    ...
    public async Task QueryAsyncT_NullableProperties_HandledCorrectly()
    {
        ...
        await foreach (var item in connection.StreamAsync<NullableDto>(
