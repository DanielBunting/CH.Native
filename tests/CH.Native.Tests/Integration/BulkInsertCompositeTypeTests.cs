...
public class BulkInsertCompositeTypeTests
{
    ...
    public async Task BulkInsert_ArrayOfArray_RoundTrips()
    {
        ...
        try
        {
            ...
            await foreach (var row in connection.QueryStreamAsync($"SELECT id, nested_arr FROM {tableName} ORDER BY id"))
            {
    ...
    public async Task BulkInsert_RectangularInt2D_RoundTrips()
    {
        ...
        try
        {
            ...
            await foreach (var row in connection.QueryStreamAsync($"SELECT id, grid FROM {tableName} ORDER BY id"))
            {
    ...
    public async Task BulkInsert_RectangularInt2D_RoundTrips_ReadAsRectangular()
    {
        ...
        try
        {
            ...
            await foreach (var row in connection.QueryStreamAsync<RectInt2DRow>($"SELECT id, grid FROM {tableName} ORDER BY id"))
            {
                read.Add(row);
            }
    ...
    public async Task BulkInsert_RaggedSource_FailsCleanlyOnRectRead()
    {
        ...
        try
        {
            ...
            {
                await foreach (var _ in connection.QueryStreamAsync<RectInt2DRow>($"SELECT id, grid FROM {tableName}"))
                {
    ...
    public async Task BulkInsert_RectangularNullableInt2D_RoundTrips()
    {
        ...
        try
        {
            ...
            await foreach (var row in connection.QueryStreamAsync($"SELECT grid FROM {tableName} WHERE id = 1"))
            {
    ...
    public async Task BulkInsert_RectangularInt3D_RoundTrips()
    {
        ...
        try
        {
            ...
            await foreach (var row in connection.QueryStreamAsync($"SELECT cube FROM {tableName} WHERE id = 1"))
            {
    ...
    public async Task BulkInsert_RectangularInt4D_RoundTrips()
    {
        ...
        try
        {
            ...
            await foreach (var row in connection.QueryStreamAsync($"SELECT tess FROM {tableName} WHERE id = 1"))
            {
    ...
    public async Task BulkInsert_ArrayOfNullable_RoundTrips()
    {
        ...
        try
        {
            ...
            await foreach (var row in connection.QueryStreamAsync($"SELECT tags FROM {tableName}"))
            {
    ...
    public async Task BulkInsert_MapWithNullableValue_RoundTrips()
    {
        ...
        try
        {
            ...
            await foreach (var row in connection.QueryStreamAsync($"SELECT metadata FROM {tableName}"))
            {
    ...
    public async Task BulkInsert_TupleWithNullable_RoundTrips()
    {
        ...
        try
        {
            ...
            await foreach (var row in connection.QueryStreamAsync($"SELECT pair FROM {tableName} ORDER BY id"))
            {
    ...
    public async Task BulkInsert_ArrayOfTuple_RoundTrips()
    {
        ...
        try
        {
            ...
            await foreach (var row in connection.QueryStreamAsync($"SELECT items FROM {tableName}"))
            {
    ...
    public async Task BulkInsert_LowCardinalityFixedString_RoundTrips()
    {
        ...
        try
        {
            ...
            await foreach (var row in connection.QueryStreamAsync($"SELECT code FROM {tableName} ORDER BY id"))
            {
    ...
    public async Task BulkInsert_NestedType_RoundTrips()
    {
        ...
        try
        {
            ...
            await foreach (var row in connection.QueryStreamAsync($"SELECT id, a, b FROM {tableName} ORDER BY id"))
            {
                var id = row.GetFieldValue<int>("id");
