...
public class BulkInsertTests
{
    ...
    public async Task BulkInsert_SimpleRow_RoundTrips()
    {
        ...
        try
        {
            ...
            await foreach (var row in connection.QueryStreamAsync($"SELECT Name FROM {tableName} ORDER BY Id"))
            {
    ...
    public async Task BulkInsert_LowCardinalityString_RoundTrips()
    {
        ...
        try
        {
            ...
            await foreach (var row in connection.QueryStreamAsync($"SELECT Status FROM {tableName} ORDER BY Id"))
            {
    ...
    public async Task BulkInsert_MultipleLowCardinalityColumns_RoundTrips()
    {
        ...
        try
        {
            ...
            await foreach (var row in connection.QueryStreamAsync($"SELECT Level, Service FROM {tableName} ORDER BY Id"))
            {
